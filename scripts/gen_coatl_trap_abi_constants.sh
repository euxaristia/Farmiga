...

{
  ...
  echo "fn gen_trap_snapshot_abi_off_x0() -> i32 { return $off_x0; }"
  echo "fn gen_trap_snapshot_abi_off_x1() -> i32 { return $off_x1; }"
  echo "fn gen_trap_snapshot_abi_off_x2() -> i32 { return $off_x2; }"

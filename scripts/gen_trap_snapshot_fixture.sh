...
off_x0="$(sym_dec trap_snapshot_off_x0)"
off_x1="$(sym_dec trap_snapshot_off_x1)"
off_x2="$(sym_dec trap_snapshot_off_x2)"
...

{
  ...
  echo "trap_snapshot_off_x0=$off_x0"
  echo "trap_snapshot_off_x1=$off_x1"
  echo "trap_snapshot_off_x2=$off_x2"
  ...
  echo "fixture_svc_x0=11"
  echo "fixture_svc_x1=12"
  echo "fixture_svc_x2=13"
  ...
  echo "fixture_brk_x0=0"
  echo "fixture_brk_x1=0"
  echo "fixture_brk_x2=0"
